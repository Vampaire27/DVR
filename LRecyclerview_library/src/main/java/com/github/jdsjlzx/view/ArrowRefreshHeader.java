...
public class ArrowRefreshHeader extends LinearLayout implements IRefreshHeader {
    ...
    private void initView() {
        ...
        mContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(R.layout.layout_recyclerview_refresh_header, null, false);
    ...
    private View initIndicatorView(int style) {
        AVLoadingIndicatorView progressView = (AVLoadingIndicatorView) LayoutInflater.from(getContext()).inflate(R.layout.layout_indicator_view, null, false);
