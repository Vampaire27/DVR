...
public class CameraSubWindow implements PopupWindow.OnDismissListener, AdapterView.OnItemClickListener {
    ...
    public CameraSubWindow(Context context, OnCameraDismissListener settingDismissListener) {
    ...
    private void initView(View view){
        if(view != null) {
            ...
            listView.setOnItemClickListener(CameraSubWindow.this);
        }
