package com.wwc2.dvr.binding.viewadapter.recyclerview;
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (onScrollChangeCommand != null) {
                    onScrollChangeCommand.execute(recyclerView,new ScrollDataWrapper(dx, dy, state));
                }
            }
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (onScrollStateChangedCommand != null) {
                    onScrollStateChangedCommand.execute(recyclerView,newState);
                }
            }
        });
            ...
            methodInvoke.throttleFirst(1, TimeUnit.SECONDS)
                    .subscribe(new Consumer<Integer>() {
                        ...
                        public void accept(Integer integer) throws Exception {
                            onLoadMoreCommand.execute(null,integer);
                        }
                    });
        }
