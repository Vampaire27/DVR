package com.wwc2.dvr.binding.viewadapter.listview;
...
public final class ViewAdapter {
        ...
        listView.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (onScrollStateChangedCommand != null) {
                    onScrollStateChangedCommand.execute(view,scrollState);
                }
            }
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                if (onScrollChangeCommand != null) {
                    onScrollChangeCommand.execute(view,new ListViewScrollDataWrapper(scrollState, firstVisibleItem, visibleItemCount, totalItemCount));
                }
            }
        });
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (onItemClickCommand != null) {
                    onItemClickCommand.execute(view,position);
                }
            }
        });
    }
    ...
    public static class OnScrollListener implements AbsListView.OnScrollListener {
        ...
        public OnScrollListener(final ListView listView, final BindingCommand<Integer> onLoadMoreCommand) {
            ...
            methodInvoke.throttleFirst(1, TimeUnit.SECONDS)
                    .subscribe(new Consumer<Integer>() {
                        ...
                        public void accept(Integer integer) throws Exception {
                            onLoadMoreCommand.execute(listView,integer);
                        }
                    });
        }
