package com.wwc2.dvr.binding.viewadapter.viewpager;
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                if (onPageScrolledCommand != null) {
                    onPageScrolledCommand.execute(viewPager,new ViewPagerDataWrapper(position, positionOffset, positionOffsetPixels, state));
                }
            }
            ...
            public void onPageSelected(int position) {
                if (onPageSelectedCommand != null) {
                    onPageSelectedCommand.execute(viewPager,position);
                }
            }
            ...
            public void onPageScrollStateChanged(int state) {
                ...
                if (onPageScrollStateChangedCommand != null) {
                    onPageScrollStateChangedCommand.execute(viewPager,state);
                }
            }
        });
