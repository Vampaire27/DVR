...
public class CustomPopWindow {
    ...
    private PopupWindow build(){
        ...
        LogUtils.d("------------------show PopupWindow build------------------");
        ...
        mPopupWindow.setBackgroundDrawable(mBackgroundDrawable == null ? new ColorDrawable(Color.TRANSPARENT) :
                mBackgroundDrawable);
    ...
    public void dissmiss(){
        ...
        LogUtils.d("------------------PopupWindow dissmiss------------------");
        if(mPopupWindow!=null){
            if(mPopupWindow.isShowing()){
                mPopupWindow.dismiss();
            }
